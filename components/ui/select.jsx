...
function SelectItem({
  ...
  return (
    (<SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-black focus:text-white relative flex w-full cursor-default items-center rounded py-1.5 ps-8 pe-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50",
        className
      )}
      {...props}>
